...
RESOURCES += src/qt/motion.qrc src/qt/motion_locale.qrc

TRANSLATIONS += src/qt/locale/motion_bg.ts \
                src/qt/locale/motion_de.ts \
                src/qt/locale/motion_en.ts \
                src/qt/locale/motion_es.ts \
                src/qt/locale/motion_fi.ts \
                src/qt/locale/motion_fr.ts \
                src/qt/locale/motion_it.ts \
                src/qt/locale/motion_ja.ts \
                src/qt/locale/motion_pl.ts \
                src/qt/locale/motion_pt.ts \
                src/qt/locale/motion_ru.ts \
                src/qt/locale/motion_sk.ts \
                src/qt/locale/motion_sv.ts \
                src/qt/locale/motion_vi.ts \
                src/qt/locale/motion_zh_CN.ts \
                src/qt/locale/motion_zh_TW.ts
