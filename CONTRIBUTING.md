...
The Motion Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Motion Core project, and is not to be
confused with overall MOTION Network Protocol consensus changes.

Whether a pull request is merged into Motion Core rests with the project merge
...
Patches that change MOTION consensus rules are considerably more involved than
...
Where a patch set proposes to change the MOTION consensus, it must have been
