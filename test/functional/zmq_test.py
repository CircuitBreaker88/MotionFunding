...
from test_framework.test_framework import MotionTestFramework, SkipTest
...
class ZMQTest (MotionTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that motion has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("motiond has not been built with zmq enabled.")
