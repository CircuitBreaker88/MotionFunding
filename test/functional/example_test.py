...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MotionTestFramework
    pass

class ExampleTest(MotionTestFramework):
    # Each functional test is a subclass of the MotionTestFramework class.
    ...
    def custom_method(self):
        ...
        MotionTestFramework class so other tests can use it."""
