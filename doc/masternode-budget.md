...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<motion_address\> \<monthly_payment_motion\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ XMNF, _12_ times over the course of a year totaling _24000_ XMNF.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<motion_address\> \<monthly_payment_motion\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` XMNF.
 ...
 * vote-many          - Vote on a Motion initiative
 * vote-alias         - Vote on a Motion initiative
 * vote               - Vote on a Motion initiative/budget
