...
////////////////////////////////////////////////////////////// // motion
	void setMotionSchedule(EVMSchedule _motionSchedule) const { motionSchedule = _motionSchedule; }

	EVMSchedule& getMotionSchedule() const { return motionSchedule; }
...
private:
	...
	mutable EVMSchedule motionSchedule; // motion
