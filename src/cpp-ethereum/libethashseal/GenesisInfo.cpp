...
#include "genesis/motionMainNetwork.cpp"
#include "genesis/motionTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::motionMainNetwork: return c_genesisInfoMotionMainNetwork;
	case Network::motionTestNetwork: return c_genesisInfoMotionTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::motionMainNetwork: return c_genesisStateRootMotionMainNetwork;
	case Network::motionTestNetwork: return c_genesisStateRootMotionTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
