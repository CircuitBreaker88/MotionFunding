...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(XMNF);
    unitlist.append(mXMNF);
    unitlist.append(uXMNF);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    ...
    case XMNF:
        return QString("XMNF");
    case mXMNF:
        return QString("mXMNF");
    case uXMNF:
        return QString::fromUtf8("uXMNF");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        switch (unit) {
        case XMNF:
            return QString("tXMNF");
        case mXMNF:
            return QString("mtXMNF");
        case uXMNF:
            return QString::fromUtf8("μtXMNF");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case XMNF:
            return QString("XMNF");
        case mXMNF:
            return QString("Milli-XMNF (1 / 1" THIN_SP_UTF8 "000)");
        case uXMNF:
            return QString("Micro-XMNF (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case XMNF:
            return QString("TestXMNFs");
        case mXMNF:
            return QString("Milli-TestXMNF (1 / 1" THIN_SP_UTF8 "000)");
        case uXMNF:
            return QString("Micro-TestXMNF (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
